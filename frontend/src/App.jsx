    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
        <div className="flex flex-col items-center gap-4 rounded-3xl bg-white/90 border border-slate-200 shadow-2xl shadow-slate-500/10 p-10">
          <img src={logo} alt="JaivikDrishti logo" className="w-24 h-24 object-cover rounded-full" />
          <div className="text-center">
            <h1 className="text-2xl font-bold text-slate-900">JaivikDrishti AI</h1>
            <p className="text-sm text-slate-500">Loading smart farming experience…</p>
          </div>
        </div>
      </div>
    )
